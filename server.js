...
const ENEMY_POOLS = {
  low: [
    ...
    {name:'Undead Skeleton',    type:'Undead',  threat:'Low',      hp:15, ac:10,atk:3,xp:1,gold:[0,5], undead:true},
  ...
  mid: [
    ...
    {name:'Wight',              type:'Undead',  threat:'Moderate', hp:28, ac:12,atk:4,xp:2,gold:[5,15], undead:true,lifeLeech:true},
    {name:'Plague Monk',        type:'Chaos',   threat:'Moderate', hp:19, ac:13,atk:3,xp:2,gold:[0,0],  diseased:true},
  ],
  high: [
    ...
    {name:'Skaven Warlord',     type:'Skaven',  threat:'High',     hp:32, ac:14,atk:5,xp:3,gold:[10,30], diseased:true},
  ],
  // Boss tier 1 (depth 10) — random pick between these two
  boss1: [
    {name:'Skaven Warlord Gnashteeth', type:'Skaven Boss', threat:'Boss',hp:80, ac:15,atk:6,xp:5,gold:[30,80]},
    {name:'Beastlord Kragthor',        type:'Chaos Boss',  threat:'Boss',hp:95, ac:16,atk:7,xp:5,gold:[25,70]},
  ],
  // Boss tier 2 (depth 20) — random pick between these two
  boss2: [
    {name:'Varghulf',                  type:'Undead Boss', threat:'Boss',hp:120,ac:15,atk:7,xp:5,gold:[40,100],undead:true,lifeLeech:true,regen:true},
    {name:'Bonebreaker Ratogre',       type:'Daemon Boss', threat:'Boss',hp:120,ac:16,atk:8,xp:5,gold:[50,120],insanityAtk:true},
  ],
  // Boss tier 3 (depth 30) — always Saurian Ancient
  boss3: [
    {name:'Saurian Ancient',           type:'Ancient Boss',threat:'Boss',hp:200,ac:15,atk:7,xp:5,gold:[60,150],undead:true,lifeLeech:true},
  ],
};
